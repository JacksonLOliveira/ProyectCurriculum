let inputNome = document.querySelector("#inputnovoNome");
let sendNome = document.querySelector("#btnAddNome");
...
sendNome.addEventListener('click', (e) => {
...
function adicionarNomeCompleto(nomecompleto){
...
function criarTagLI(nomecompleto) {
